document.addEventListener('DOMContentLoaded', function () {
  ...
  function runTests() {
    ...
    it('deve falhar ao adicionar números incorretos', function () {
      ...
      //FUNÇÃO DE DIVISAO
    it('deve retornar a divisao correta de números decimais', function () {
      expect(dividir(2.5, 1.5)).toBeCloseTo(4);
    });
    it('deve retornar NaN ao adicionar valores inválidos', function () {
    ...
    it('deve retornar a divisao de números negativos e negativos', function () {
      expect(dividir(-6, -3)).toBe(+9);
      expect(dividir(-10, -2)).toBe(+12);
    });
